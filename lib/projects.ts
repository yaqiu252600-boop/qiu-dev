...
export const projects: Project[] = [
  {
    slug: "pdf-to-word",
    title: "PDF 转 Word",
    description: "在线 PDF 转 Word 工具，调用本地转换引擎生成可编辑 Word 文档。",
    longDescription:
      "这是 qiu.dev 的第一个可用工具项目。当前已接入本地 PDF 转 Word 转换引擎，支持上传 PDF、调用本机转换程序生成可编辑 Word 文档，并提供下载链接。",
    status: "live",
    type: "工具",
  ...
  },
  {
    ...
    title: "高考志愿辅助系统",
    description: "根据分数、省份、兴趣与院校数据生成志愿填报建议。",
    longDescription:
      "面向高考志愿填报场景的 AI 教育产品实验。目标是结合分数、省份、科类、兴趣方向和院校数据，生成更清晰的志愿建议和解释说明。",
    status: "dev",
    type: "AI / 教育",
    tags: ["Next.js", "AI", "Data"],
    demoUrl: "/projects/gaokao-volunteer",
    githubUrl: "https://github.com/",
    progress: 65,
    updatedAt: "2026-06-29",
    eta: "2026 Q3",
    completed: ["数据结构设计", "推荐逻辑初版", "结果解释页面草稿"],
    nextSteps: ["AI 推荐说明生成", "补充院校筛选条件", "准备 Beta 测试数据"],
  },
  {
    slug: "career-planner",
    title: "职业规划助手",
